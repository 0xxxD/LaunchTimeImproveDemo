...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/0xxxd/ApplicationModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '0xxxd' => '0xxxd0210@gmail.com' }
  s.source           = { :git => 'https://github.com/0xxxd/ApplicationModule.git', :tag => s.version.to_s }
  ...
  # s.frameworks = 'UIKit', 'MapKit'
   ...
   s.dependency 'LaunchTimeMeasurer'
   s.dependency 'LaunchManager'
end
